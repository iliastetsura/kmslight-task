...
test('Validate Book a Demo link navigation', async ({ bookADemoPage, homePage, page }) => {
    // Generate test data
...
test('Validate “I Need Knowledge Management” section', async ({ homePage, page }) => {
...
test('Validate Our Solutions navigation links', async ({ homePage }) => {
...
test('Validate Blog Search', async ({ blogPage, homePage, page }) => {
    // Click Resources header link
    homePage.header.clickResourcesLink();
